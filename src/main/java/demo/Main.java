...
//
    System.out.println(
        "--------------Find By First Name   " + personService.findPersonByFirstName("Rishabh"));
    System.out.println(
...
//    // Question 6
    ...
    // Question 9
    System.out.println("-------------Query for count  " + personService.queryForCount("Rishabh"));

    // Quertion 10
    System.out.println("-------------Count by name   " + personService.countPerson("Rishabh"));
    System.out.println("-------------Distinct Age   " + personService.findDistinctAge(24));
    System.out.println("-------------Or   " + personService.findNameorAge("Rishabh", 35));
    System.out.println("-------------Abd   " + personService.findNameandAge("Rishabh", 24));
    ...
    System.out.println("-------------Not Demo" + personService.notDemo("Rajput"));
    ...
    // Named Native Query
    System.out.println(
        "--------------Named Native Query  " + personService.nativeNamedDemo("Rishabh"));
